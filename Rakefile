...
task :freebsd_x86_64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_freebsd_x86_64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
...
task :freebsd_arm64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_freebsd_arm64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
...
task :netbsd_x86_64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_netbsd_x86_64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
...
task :openbsd_x86_64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_openbsd_x86_64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
...
task :openbsd_arm64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_openbsd_arm64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
...
task :openindiana_x86_64 do
  ...
  puts "done"
  print "Copying ruby executable..."
  `cp ./src/ruby_openindiana_x86_64 /usr/local/share/rubyfetch/`
  puts "done"
  print "Copying logos..."
  `cp -r ./src/logos /usr/local/share/rubyfetch/`
  puts "done"
